...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/exchangeRate/updateER" method="post" onsubmit="return Submit()">
        ...
        <div class="form-group">
            <label>货币：</label>
            <input type="text" name="currency" id="currency" value="${Qer.currency}" class="form-control" required>
        </div>
        <div class="form-group">
            <label>名称：</label>
            <input type="text" name="name" id="name" value="${Qer.name}" class="form-control" required>
        </div>
        <div class="form-group">
            <label>数据：</label>
            <input type="text" name="data" id="data" value="${Qer.data}" class="form-control" readonly="readonly">
        </div>
        <div class="form-group">
