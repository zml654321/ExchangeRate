...
<head>
    ...
    <script type="text/javascript">
        function back() {
            window.location.href='${pageContext.request.contextPath}/exchangeRate/queryER?page=${"/IR/edit"}';
        }
    </script>
</head>
<body>
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/exchangeRate/updateER"  id="form1"  method="post">
        ...
        <div class="form-group">
            <label>数据：</label>
            <input type="text" name="data_memory" id="data_memory" value="${Qer.data}" class="form-control" required >
        </div>
